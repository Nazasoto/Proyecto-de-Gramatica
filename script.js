...
document.addEventListener("DOMContentLoaded", function() {
    ...
    let respuestasCorrectas = ["el","noche", "yaci", "araí", "nube", "tierra", "mujeres", "belleza", "selva", "senderos", "vegetación", "yaguareté", "salto", "horror", "fiera", "paso", "aire", "viejo", "lugar", "peligro", "arquero", "corazón", "formas", "cielos", "sueño", "nobleza", "regalo", "plantas", "hojas", "infusión", "bebida", "cansado", "débil", "mate", "símbolo", "hermanandad", "hombres", "una", "la", "un", "las"];
